...
if [ "$IDF_TARGET" = "esp32" ]; then
	...
	$SED -i '/CONFIG_ESP32S3_DEFAULT_CPU_FREQ_80/c\# CONFIG_ESP32S3_DEFAULT_CPU_FREQ_80 is not set' ./sdkconfig
	$SED -i '/CONFIG_ESP32S3_DEFAULT_CPU_FREQ_160/c\CONFIG_ESP32S3_DEFAULT_CPU_FREQ_160 is not set' ./sdkconfig
	$SED -i '/CONFIG_ESP32S3_DEFAULT_CPU_FREQ_240/c\# CONFIG_ESP32S3_DEFAULT_CPU_FREQ_240=y' ./sdkconfig
	$SED -i '/CONFIG_ESP32S3_DEFAULT_CPU_FREQ_MHZ/c\CONFIG_ESP32S3_DEFAULT_CPU_FREQ_MHZ=240' ./sdkconfig
